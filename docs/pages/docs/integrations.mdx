...
With the runtime appRouter object, you can integrate with virtually any trpc-specific library, this includes [trpc-ui](https://github.com/aidansunbury/trpc-ui), [trpc-openapi](https://github.com/jlalmes/trpc-openapi), [trpc-playground](https://github.com/sachinraja/trpc-playground) and more.

### Integrating with `trpc-ui`
Here is a short example of how to integrate [trpc-ui](https://github.com/aidansunbury/trpc-ui), while this is a specific integration, the techniques used here can be applied to any of the trpc-specific libraries you wish to include. <br/>
...
<Steps>
  ### Installation
  To install `trpc-ui` with your preferred package manager, you can use any of the following commands:
  ...
  As per the `trpc-ui` [docs](https://github.com/aidansunbury/trpc-ui?tab=readme-ov-file#quick-start) we need to serve the panel, using the `renderTrpcPanel` method for every method on route `/panel`.
